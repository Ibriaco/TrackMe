	...
	\section{Implementation, Integration and Test Plan}
		...
		In the following sections we are going to illustrate how external components will be integrated with the ones implemented for the system and what testing strategy will be adopted.
			...
			\begin{itemize}
				...
				\item The modules which are being integrated in the system are supposed to have at least the operations concerning on another created, if not carried out completely. 
			...
			\end{itemize} 
			Furthermore, in order to test the integration of two generic components, the main featues of both of them should have been developed (partially, if not completely) and the related test units should have been performed. More clearly, there are minimum coverage percentages of completion of each component with its functionalities that have to be reached:
			\begin{itemize}
